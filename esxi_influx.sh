...
curl -i -XPOST 'http://influx.brad:8086/write?db=local_reporting&precision=s' --data-binary "esxi_stats,host=esxi1,type=memory_usage percent=$pcent,free=$freemem,used=$used $epoch_seconds
